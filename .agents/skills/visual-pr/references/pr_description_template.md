...
- **Before:** {Screenshot, failing test, command output, or other executed evidence showing the previous behavior.}
- **After:** {Screenshot, passing test, command output, or other executed evidence showing the new behavior.}

## Merge danger

- **Door:** {One-way or two-way.}
- **Blast radius:** {The users, data, systems, interfaces, or workflows that could be affected.}
- **Rollback:** {How to reverse the change, or why reversal is constrained. Omit when obvious for a two-way door.}
